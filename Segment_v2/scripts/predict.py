...
def main(config):
    ...
    # TODO: 测试其他数据集
    # dataset_dir = r"E:\Code\RiceLodging\datasets\Meiju1_2_Lingtangkou\abnormal-03.15-7-640-0.6-0.2-0.2-v5.1"
    # print("❌❌❌❌Warnings: I Change the data path here, please change it back❌❌❌❌")
